...
async function run() {
  try {
    ...
    const serviceCollation = client.db('serviceCar').collection('service');
    const productCollaction = client.db('products').collection('product');
    ...
    app.get('/products',async(req,res)=>{
        const corsor = productCollaction.find();
    ...
    app.get('/services/:id',async(req,res)=>{
      ...
      const result = await serviceCollation.findOne(query,options)
      res.send(result)
    })
